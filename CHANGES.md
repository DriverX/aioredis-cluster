...
* add support fot Python 3.11
* changed acquire connection behaviour from connection pool. Now connection acquire and release to pool by LIFO way for better idle connection detection
