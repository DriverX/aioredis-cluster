...
@pytest.mark.parametrize(
    ...
    [
        ...
        (
            ...
            ("localhost", 6379),
            {"ssl": True, "username": "user", "password": "secret"},
        ),
        (
        ...
        ("rediss://localhost?timeout=1.0", ("localhost", 6379), {"ssl": True, "timeout": 1.0}),
        ("rediss://localhost?timeout=10", ("localhost", 6379), {"ssl": True, "timeout": 10.0}),
        # unix scheme
        ("unix:///", "/", {}),
...
@pytest.mark.parametrize(
    ...
    [
        ...
        ("unix://host:123/", ("Netlocation is not allowed for unix scheme", "host:123")),
        (
            "unix://user:pass@host:123/",
            ("Netlocation is not allowed for unix scheme", "user:pass@host:123"),
        ),
        ("unix://user:pass@/", ("Netlocation is not allowed for unix scheme", "user:pass@")),
        ...
        ("redis:///?ssl=True", ("Expected 'ssl' param to be 'true' or 'false' only", "True")),
    ],
)
